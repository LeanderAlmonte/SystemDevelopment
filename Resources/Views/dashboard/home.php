...
class Home {
    public function render($data = null) {
        ...
        <head>
            ...
            <title><?php echo lang('dashboard'); ?> - Eyesightcollectibles</title>
        ...
        <body<?php $theme = $_SESSION['theme'] ?? 'Light'; echo $theme === 'Dark' ? ' class="dark-theme"' : ''; ?>>
            <div class="container">
                ...
                <div class="menu-panel">
                    ...
                    <ul class="menu-items">
                        <li><a href="/ecommerce/Project/SystemDevelopment/index.php?url=dashboards" class="active"><i class="fas fa-home"></i><span><?php echo lang('home'); ?></span></a></li>
                    ...
                    <div class="dashboard-container">
                        <div class="dashboard-grid">
                            ...
                            <div class="dashboard-card">
                                <h3><i class="fas fa-trophy"></i> <?php echo lang('top_best_sellers'); ?></h3>
                                    ...
                                    <?php if (isset($data['bestSellers']) && !empty($data['bestSellers'])): ?>
                                        <?php foreach ($data['bestSellers'] as $index => $product): ?>
                                            <li class="product-item">
                                                ...
                                                <span><?php echo htmlspecialchars($product['totalSold']) . ' ' . lang('sold'); ?></span>
                                            </li>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                        <li class="product-item"><?php echo lang('no_sales_data'); ?></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                            ...
                            <!-- Top 5 Most Stocked -->
                            <div class="dashboard-card">
                                <h3><i class="fas fa-box"></i> <?php echo lang('top_most_stocked'); ?></h3>
                                <ul class="product-list">
                                    <?php if (isset($data['mostStocked']) && !empty($data['mostStocked'])): ?>
                                        <?php foreach ($data['mostStocked'] as $index => $product): ?>
                                            <li class="product-item">
                                                ...
                                                <span><?php echo htmlspecialchars($product['quantity']) . ' ' . lang('in_stock'); ?></span>
                                            </li>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                        <li class="product-item"><?php echo lang('no_stock_data'); ?></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="pokemon-card">
                            <h3><i class="fas fa-dragon"></i> <?php echo lang('random_pokemon'); ?></h3>
                            <div id="pokemonContent">
                                ...
                                <div class="stats-grid">
                                    <div class="stat-item">
                                        <div class="stat-label"><?php echo lang('height'); ?></div>
                                        <div id="pokemonHeight" class="stat-value"></div>
                                    </div>
                                    <div class="stat-item">
                                        <div class="stat-label"><?php echo lang('weight'); ?></div>
                                        <div id="pokemonWeight" class="stat-value"></div>
                                    </div>
                                </div>
                                <button class="refresh-btn" onclick="fetchRandomPokemon()">
                                    <i class="fas fa-sync-alt"></i> <?php echo lang('get_another_pokemon'); ?>
                                </button>
                            </div>
                        </div>
                    </div>

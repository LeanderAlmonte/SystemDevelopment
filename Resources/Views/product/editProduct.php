                    ...
                    <div class="edit-product-container">
                        ...
                        <form method="POST" action="/ecommerce/Project/SystemDevelopment/index.php?url=products/update" class="edit-product-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="productName" name="productName" placeholder="Enter product name" value="<?php echo htmlspecialchars($product['productName']); ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="listedPrice" name="listedPrice" placeholder="Enter listed price" step="0.01" min="0" value="<?php echo $product['listedPrice']; ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="paidPrice">Paid Price</label>
                                <input type="number" id="paidPrice" name="paidPrice" placeholder="Enter paid price" step="0.01" min="0" value="<?php echo $product['paidPrice']; ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="quantity">Quantity</label>
                                <input type="number" id="quantity" name="quantity" placeholder="Enter quantity" min="0" value="<?php echo $product['quantity']; ?>" required>
                            </div>
